...
set dataurl http://covidtracking.com/api/states/daily
...
set excludeFromR [list hash fips deathIncrease null hospitalizedIncrease negativeIncrease positiveIncrease totalTestResultsIncrease]
#set excludeFromR ""
